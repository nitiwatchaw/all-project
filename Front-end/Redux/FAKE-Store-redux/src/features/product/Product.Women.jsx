...
const ProductWomenCloth = () => {

    const products = useSelector(selectAllProducts)


    const productWomenCloth = products.filter(product => product.category === "women's clothing")
...
export default ProductWomenCloth